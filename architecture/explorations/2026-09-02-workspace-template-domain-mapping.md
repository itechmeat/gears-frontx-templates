...
7. **Does `template-workspace-chat` keep the family prefix?** It is the same template as the chat feature template a console outside this family composes. Keeping the prefix or naming it for its feature alone, as `template-chat`, is for the maintainers to settle; the same applies to any other screen once it is offered outside the family.
